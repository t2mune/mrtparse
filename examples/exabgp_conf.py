            ...
            if m.subtype == TD_V2_ST['RIB_IPV4_UNICAST']:
                ...
                for attr in m.rib.entry[0].attr:
                    if attr.type == BGP_ATTR_T['ORIGIN'] and attr.len != 0:
                        ...
                        print 'aggregator (%s:%s)' % (str(asn), attr.aggr['id']),
